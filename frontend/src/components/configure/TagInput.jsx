...
export default function TagInput({ tags, onChange, placeholder = 'Add email and press Enter' }) {
  ...
  return (
    <div>
      <div
        className={`min-h-[42px] flex flex-wrap gap-1.5 p-2 bg-surface border-[1.5px] rounded-lg transition-all focus-within:border-pando-green focus-within:shadow-[0_0_0_3px_rgba(108,92,231,0.12)] ${
